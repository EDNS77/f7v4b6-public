...
\begin{europasscv}
  ...
  \ecvsection{HABILIDADES}
    ...
    \ecvblueitem{Desenvolvimento Web, Infraestrutura em Núvem \& DevOps}{
      ...
      Na garantia de saúde e manutenibilidade do código
        com \textbf{testes automáticos} (Pytest, Playwright, nox e Coverage.py),
        linting (Ruff) e
  ...
  \ecvsection{DIPLOMAS \& CERTIFICADOS}
    ...
    \ecvitem{}{Treinamento sobre Kubernetes e o grande ecossistema de ferramentas para um (ambiente) cluster k8s.}
    ...
    \ecvitem{}{
      Curso para criação de uma aplicação web completa com a linguagem Elixir e o framework Phoenix,
        incluindo autenticação e testes automáticos.
    }
  ...
  \ecvsection{IDIOMAS}
    ...
    % \ecvlanguagecertificate{TOEFL -- Score: }
