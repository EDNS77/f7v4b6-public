...
\begin{europasscv}
  ...
  \ecvsection{EDUCAÇÃO}
    ...
    % \ecvtitle{Abril 2024}{Certificado -- LINUXtips -- Mês do Kubernetes 2024}
    % \ecvitem{}{Aprendi sobre Kubernetes e sobre o enorme ecossistema de ferramentas para um ambiente de cluster k8s.}

    % \ecvtitle{Janeiro 2023}{Curso -- LINUXtips -- Descomplicando o Docker}
    % \ecvitem{}{Aprendi a fundo sobre Docker, Docker Compose e Docker Swarm.}

    % \ecvtitle{Abril 2022}{Curso -- Udemy -- Elixir e Phoenix do zero}
    % \ecvitem{}{Aprendi a criar soluções completas com a linguagem Elixir e o framework Phoenix, já com autenticação e testes automáticos.}

    % \ecvtitle{Abril 2022}{Curso -- Programação Concorrente e Assíncrona com Python -- Udemy}
    % \ecvitem{}{Aprendi sobre concorrência, paralelismo e diversas técnicas e ferramentas para execução de código concorrente e assíncrono com Python.}
