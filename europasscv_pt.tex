...
\begin{europasscv}
  ...
  \ecvsection{FORMAÇÃO ACADÊMICA}
    \ecvtitle{Presente -- 2024}{Bacharel em Ciência da Computação -- FAESA}
    % \ecvitem{}{\textbf{TCC:} }
    ...
    \ecvtitle{2017 -- 2015}{Ensino Médio -- IFES Campus Vitória}
  ...
  \ecvsection{DIPLOMAS \& CERTIFICADOS}
    ...
    \ecvitem{}{Curso para criação de soluções completas com a linguagem Elixir e o framework Phoenix, já com autenticação e testes automáticos.}
