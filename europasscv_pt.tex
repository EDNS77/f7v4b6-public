...
%     linkcolor=cyan,        % color of internal links (sections, etc.)
...
\begin{europasscv}
  ...
  \ecvsection{EXPERIÊNCIA}
    ...
    \ecvtitle{Fevereiro 2026 -- Maio 2025}{Globalsys | Vixpar (Grupo Águia Branca) · Smartsourcing}
    \ecvitem{}{\textbf{Cargo:}
    ...
    \ecvitem{}{\begin{ecvitemize}
      ...
      \item Desenvolvi e evoluí um \textbf{dashboard de BI}
        e monitoramento de KPIs em \textbf{tempo real}
      ...
      \item Também fiz diversas análises de dados pontuais,
        além da participação na construção de relatórios executivos
        e em reuniões para comunicação com stakeholders e pessoas do negócio,
        incluindo \textbf{insights acionáveis}, construção de \textbf{storytelling} e retórica.

      \item Construção conjunta de \textbf{relatórios} em PDF (encadernáveis) com LaTex
        e \textbf{storytelling} com slides (MS 365 PowerPoint colaborativo no SharePoint).

      \item Realizei \textbf{Análise Exploratória} de Dados (EDA),
        ...
        identificação de tendências, sazonalidades, padrões e anomalias
        e por fim, geração de \textbf{insights acionáveis} para o negócio.
        Utilizando SQL, Pandas, GeoPandas, \textit{\underline{\href{https://h3geo.org/}{H3}}}, NumPy, Statsmodels, Seaborn, Plotly e PyDeck.

      \item Desenvolvi diversas \textbf{visualizações interativas} dos dados, mapas de calor e mapas tridimensionais para o dashboard,
      ...
      \item Desenvolvi consultas, agregações e transformações de dados em \textbf{SQL} / \textbf{T-SQL}
        (ocasionalmente com queries acima de 100 linhas) sobre banco de dados MS \textbf{SQL Server}
      ...
      \item Front-end com Streamlit.

      \item Implementei múltiplas camadas de \textbf{cache},
      ...
      \item Estruturei \textbf{testes automatizados} com \textbf{Pytest},
        contribuindo para a manutenibilidade e confiabilidade do dashboard.
      ...
      \item Implementei a \textbf{observabilidade} da aplicação com OTel (\textbf{OpenTelemetry})
        ...
        (via Docker Compose) usando \textbf{Prometheus}, \textbf{Grafana}, Loki, Tempo e Alloy (a distro de OTel Collector da Grafana Labs).

      \item Contribuí para a integração com o pipeline de \textbf{CI/CD} no \textbf{Azure DevOps} e com o cluster k8s,
    ...
    \ecvtitle{Fevereiro 2025 -- Setembro 2023}{Top Serviços Digitais · Autônomo}
    ...
    \ecvtitle{Setembro 2023 -- Janeiro 2017}{Ilha Informática · Freelancer}
    ...
    \ecvitem{}{\begin{ecvitemize}
      ...
      \item Criei um site de ponta-a-ponta utilizando \textbf{Django},
        ...
        faz parsing do texto exportado pelo software de detecção de hardware em uso (CPU-Z) com \textbf{RegEx}
        e integra essa solução com o sistema web de gestão (ERP) via API REST.

      \item Trabalhei no provisionamento de um cluster de servidores \textbf{CentOS} 7 voltado a HPC, e a sua infraestrutura.
      ...
      \item Na \textbf{manutenção} de diversos desktops, servidores, macs, notebooks e eventualmente de smarphones e tablets,
        ...
        pela personalização de detalhes da interface do Win10, via scripts \textbf{Batch},
        de Registro do Windows (.reg)
        e \textbf{PowerShell}.
  ...
  \ecvsection{HABILIDADES}
    ...
    \ecvblueitem{Desenvolvimento Web, Infraestrutura em Núvem \& DevOps}{
      ...
      No desenho de soluções e arquitetura usando, por exemplo, \textbf{UML}, Figma e Excalidraw;
    ...
    \ecvblueitem{Infraestrutura Local, Manutenção de computadores \& Redes}{
    ...
    \ecvblueitem{Análise de Dados}{
      Sólida experiência no desenvolvimento e implantação de \textbf{dashboards interativos},
      em \textbf{Data Visualization},
      na construção de \textbf{Relatórios},
      na criação de \textbf{Storytelling},
      na \textbf{comunicação} com stakeholders técnicos e de negócio (e apresentação de resultados),
      em \textbf{Análise Exploratória} de Dados (EDA),
      \textbf{Análise Estatística},
      Modelagem de \textbf{Séries Temporais}, \textbf{Análise Preditiva}
      e processamento e análise de dados \textbf{Geolocalizados},
      identificação de tendências, sazonalidades, padrões e anomalias
      e por fim, na geração de \textbf{insights acionáveis} para o negócio.
    }
    \ecvitem{}{\ecvhighlight{Tecnologias:}
      SQL / MS SQL Server (Intermediário) e MongoDB (Intermediário);
      Redis (Intermediário) e Elasticsearch (Básico);
      Pandas (Avançado) e Geoprocessamento c/ GeoPandas (Intermediário);
      Power BI (Básico);
      Interactive data visualization c/ Plotly (Intermediário) e PyDeck (Intermediário);
